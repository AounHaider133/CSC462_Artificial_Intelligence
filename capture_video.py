...
class Watchman:
    ...
    def check_permission(self, name, age):
        ...
        if name not in face_recognizer.names and age not in face_recognizer.ages:
...
#face_recognizer.add_face('Images/hamza2.jpeg', 'Hamza', 20)
face_recognizer.add_face('faizan.jpeg', 'Faizan', 21)
#face_recognizer.add_face('Images/abdullah.jpeg', 'Abdullah', 12)
...
if captured_frame is not None:
    ...
    watchman = Watchman()
    watchman.set_house_warden("Aoun",20)
